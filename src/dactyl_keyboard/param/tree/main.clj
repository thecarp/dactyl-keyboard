...
(def raws
  ...
  [["# General configuration options\n\n"
   ...
   [:parameter [:case :central-housing :shape :interface]
    ...
    "moving clockwise from the point of view of positive infinite x:\n"
    "\n"
    "```interface:\n"
    "  - base:\n"
    "      offset: [0, -10, 0]\n"
    ...
    "floor, inside the `mask`; this is not required. A lower z coordinate "
    "will cause the `mask` to open the bottom of the central housing, which "
