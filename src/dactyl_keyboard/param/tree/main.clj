...
(def raws
  ...
  [["# General configuration options\n\n"
   ...
   [:parameter [:case :central-housing :shape :interface]
    ...
    "\n"
    "The `interface` setting describes the shape of the housing as a list of "
    "vertices, each defined primarily by an offset in a little section (key) "
    "called `base`. The following properties are allowed in the value of "
    "`base`:\n"
    "\n"
    ...
    "It’s usually a good idea to anchor your main key cluster to one of "
    "these.\n"
    "\n"
    "In addition to this `base` section, each item in the `interface` list "
    "may also include an `adapter` section. This section, and everything in "
    "it, is optional and relates to the central housing adapter feature. "
    ...
    "and keep the housing itself more than twice as broad as its wall "
