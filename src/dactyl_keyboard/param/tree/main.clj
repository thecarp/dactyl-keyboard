...
(def raws
  ...
  [["# General configuration options\n\n"
   ...
   [:parameter [:tweaks]
    ...
    "- A non-leaf node, representing an instruction to combine nested items "
    "  in a specific way.\n"
    ...
    "and places a cuboid there. This is ordinary "
    "[anchoring](configuration.md) of very simple shapes. "
    "The elements of a leaf are, in order:\n"
    "\n"
    "1. Mandatory: An anchor.\n"
    "2. Optional: A compass point code. There is no default value.\n"
    "3. Optional: A starting vertical segment ID. "
    ...
    "\n"
    "By default, a non-leaf node will create a convex hull around its child "
    "nodes. However, this behaviour can be modified. The following keys are "
    "recognized:\n"
    "\n"
    "- `hull-around` (required): The list of child nodes.\n"
    "- `above-ground` (optional): If `true`, child nodes will be visible as "
    "part of the case. The default value is `true`.\n"
