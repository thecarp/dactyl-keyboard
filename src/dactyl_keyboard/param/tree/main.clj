...
(def raws
  ...
  [["# General configuration options\n\n"
   ...
   [:parameter [:tweaks]
    ...
    "- `intrinsic-rotation` (optional): An `[x, y, z]` vector describing "
    "angles of rotation around the center of the leaf at each segment of its "
    "anchor. Certain types of anchors will ignore this setting.\n"
    ...
    "size as well as `intrinsic-rotation`. The default size depends both "
    "on the type of anchor and on which anchoring parameters you use. "
    "For types of anchors that have no basic size associated with them, the "
    "default is a tiny point.\n"
    "\n"
