...
(def raws
  ...
  [["# General configuration options\n\n"
   ...
   [:parameter [:tweaks]
    ...
    "- A non-leaf node, representing some combination of the items in a new "
    "list like the first one.\n"
    "\n"
    "Each **leaf node** places something near a named part of the keyboard. "
    "This is ordinary [anchoring](configuration.md) of very simple shapes. "
    ...
    "The following keys are recognized in any non-leaf node:\n"
    "\n"
    ...
    "\n"
    "There are two types of non-leaf nodes: Trees and branches. "
    "The top layer of non-leaf nodes are trees. Tree nodes may contain "
