...
## Table of contents
- Section <a href="#layout">`layout`</a>
    - Section <a href="#layout-matrix">`matrix`</a>
        - Section <a href="#layout-matrix-neutral">`neutral`</a>
            - Parameter <a href="#layout-matrix-neutral-column">`column`</a>
            - Parameter <a href="#layout-matrix-neutral-row">`row`</a>
        - Section <a href="#layout-matrix-separation">`separation`</a>
            - Parameter <a href="#layout-matrix-separation-column">`column`</a>
            - Parameter <a href="#layout-matrix-separation-row">`row`</a>
    - Section <a href="#layout-pitch">`pitch`</a>
        - Parameter <a href="#layout-pitch-base">`base`</a>
        - Parameter <a href="#layout-pitch-intrinsic">`intrinsic`</a>
        - Parameter <a href="#layout-pitch-progressive">`progressive`</a>
    - Section <a href="#layout-roll">`roll`</a>
        - Parameter <a href="#layout-roll-base">`base`</a>
        - Parameter <a href="#layout-roll-intrinsic">`intrinsic`</a>
        - Parameter <a href="#layout-roll-progressive">`progressive`</a>
    - Section <a href="#layout-yaw">`yaw`</a>
        - Parameter <a href="#layout-yaw-base">`base`</a>
        - Parameter <a href="#layout-yaw-intrinsic">`intrinsic`</a>
    - Section <a href="#layout-translation">`translation`</a>
        - Parameter <a href="#layout-translation-early">`early`</a>
        - Parameter <a href="#layout-translation-mid">`mid`</a>
        - Parameter <a href="#layout-translation-late">`late`</a>
- Parameter <a href="#key-style">`key-style`</a>
- Section <a href="#channel">`channel`</a>
    - Parameter <a href="#channel-height">`height`</a>
    - Parameter <a href="#channel-top-width">`top-width`</a>
    - Parameter <a href="#channel-margin">`margin`</a>
- Section <a href="#wall">`wall`</a>
    - Parameter <a href="#wall-thickness">`thickness`</a>
    - Parameter <a href="#wall-bevel">`bevel`</a>
    - Section <a href="#wall-north">`north`</a>
        - Parameter <a href="#wall-north-extent">`extent`</a>
        - Parameter <a href="#wall-north-parallel">`parallel`</a>
        - Parameter <a href="#wall-north-perpendicular">`perpendicular`</a>
    - Section <a href="#wall-east">`east`</a>
        - Parameter <a href="#wall-east-extent">`extent`</a>
        - Parameter <a href="#wall-east-parallel">`parallel`</a>
        - Parameter <a href="#wall-east-perpendicular">`perpendicular`</a>
    - Section <a href="#wall-south">`south`</a>
        - Parameter <a href="#wall-south-extent">`extent`</a>
        - Parameter <a href="#wall-south-parallel">`parallel`</a>
        - Parameter <a href="#wall-south-perpendicular">`perpendicular`</a>
    - Section <a href="#wall-west">`west`</a>
        - Parameter <a href="#wall-west-extent">`extent`</a>
        - Parameter <a href="#wall-west-parallel">`parallel`</a>
        - Parameter <a href="#wall-west-perpendicular">`perpendicular`</a>
