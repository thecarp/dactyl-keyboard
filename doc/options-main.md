...
## Table of contents
- Parameter <a href="#split">`split`</a>
- Section <a href="#keys">`keys`</a>
    - Parameter <a href="#keys-preview">`preview`</a>
    - Parameter <a href="#keys-styles">`styles`</a>
- Special section `<a href="#key-clusters">`key-clusters`</a>`
- Section <a href="#by-key">`by-key`</a>
    - Special recurring section `<a href="#by-key-parameters">`parameters`</a>`
    - Special section `<a href="#by-key-clusters">`clusters`</a>` ← overrides go in here
- Parameter <a href="#secondaries">`secondaries`</a>
- Section <a href="#case">`case`</a>
    - Parameter <a href="#case-key-mount-thickness">`key-mount-thickness`</a>
    - Parameter <a href="#case-key-mount-corner-margin">`key-mount-corner-margin`</a>
    - Parameter <a href="#case-web-thickness">`web-thickness`</a>
    - Section <a href="#case-rear-housing">`rear-housing`</a>
        - Parameter <a href="#case-rear-housing-include">`include`</a>
        - Parameter <a href="#case-rear-housing-wall-thickness">`wall-thickness`</a>
        - Parameter <a href="#case-rear-housing-roof-thickness">`roof-thickness`</a>
        - Section <a href="#case-rear-housing-position">`position`</a>
            - Parameter <a href="#case-rear-housing-position-cluster">`cluster`</a>
            - Section <a href="#case-rear-housing-position-offsets">`offsets`</a>
                - Parameter <a href="#case-rear-housing-position-offsets-north">`north`</a>
                - Parameter <a href="#case-rear-housing-position-offsets-west">`west`</a>
                - Parameter <a href="#case-rear-housing-position-offsets-east">`east`</a>
                - Parameter <a href="#case-rear-housing-position-offsets-south">`south`</a>
        - Parameter <a href="#case-rear-housing-height">`height`</a>
        - Section <a href="#case-rear-housing-fasteners">`fasteners`</a>
            - Parameter <a href="#case-rear-housing-fasteners-diameter">`diameter`</a>
            - Parameter <a href="#case-rear-housing-fasteners-bosses">`bosses`</a>
            - Section <a href="#case-rear-housing-fasteners-west">`west`</a>
                - Parameter <a href="#case-rear-housing-fasteners-west-include">`include`</a>
                - Parameter <a href="#case-rear-housing-fasteners-west-offset">`offset`</a>
            - Section <a href="#case-rear-housing-fasteners-east">`east`</a>
                - Parameter <a href="#case-rear-housing-fasteners-east-include">`include`</a>
                - Parameter <a href="#case-rear-housing-fasteners-east-offset">`offset`</a>
    - Section <a href="#case-back-plate">`back-plate`</a>
        - Parameter <a href="#case-back-plate-include">`include`</a>
        - Parameter <a href="#case-back-plate-beam-height">`beam-height`</a>
        - Section <a href="#case-back-plate-fasteners">`fasteners`</a>
            - Parameter <a href="#case-back-plate-fasteners-diameter">`diameter`</a>
            - Parameter <a href="#case-back-plate-fasteners-distance">`distance`</a>
            - Parameter <a href="#case-back-plate-fasteners-bosses">`bosses`</a>
        - Section <a href="#case-back-plate-position">`position`</a>
            - Parameter <a href="#case-back-plate-position-anchor">`anchor`</a>
            - Parameter <a href="#case-back-plate-position-offset">`offset`</a>
    - Section <a href="#case-bottom-plate">`bottom-plate`</a>
        - Parameter <a href="#case-bottom-plate-include">`include`</a>
        - Parameter <a href="#case-bottom-plate-preview">`preview`</a>
        - Parameter <a href="#case-bottom-plate-combine">`combine`</a>
        - Parameter <a href="#case-bottom-plate-thickness">`thickness`</a>
        - Section <a href="#case-bottom-plate-installation">`installation`</a>
            - Parameter <a href="#case-bottom-plate-installation-style">`style`</a>
            - Parameter <a href="#case-bottom-plate-installation-thickness">`thickness`</a>
            - Section <a href="#case-bottom-plate-installation-inserts">`inserts`</a>
                - Parameter <a href="#case-bottom-plate-installation-inserts-length">`length`</a>
                - Section <a href="#case-bottom-plate-installation-inserts-diameter">`diameter`</a>
                    - Parameter <a href="#case-bottom-plate-installation-inserts-diameter-top">`top`</a>
                    - Parameter <a href="#case-bottom-plate-installation-inserts-diameter-bottom">`bottom`</a>
            - Section <a href="#case-bottom-plate-installation-fasteners">`fasteners`</a>
                - Parameter <a href="#case-bottom-plate-installation-fasteners-diameter">`diameter`</a>
                - Parameter <a href="#case-bottom-plate-installation-fasteners-length">`length`</a>
                - Parameter <a href="#case-bottom-plate-installation-fasteners-positions">`positions`</a>
    - Section <a href="#case-leds">`leds`</a>
        - Parameter <a href="#case-leds-include">`include`</a>
        - Section <a href="#case-leds-position">`position`</a>
            - Parameter <a href="#case-leds-position-cluster">`cluster`</a>
        - Parameter <a href="#case-leds-amount">`amount`</a>
        - Parameter <a href="#case-leds-housing-size">`housing-size`</a>
        - Parameter <a href="#case-leds-emitter-diameter">`emitter-diameter`</a>
        - Parameter <a href="#case-leds-interval">`interval`</a>
    - Parameter <a href="#case-tweaks">`tweaks`</a>
    - Section <a href="#case-foot-plates">`foot-plates`</a>
        - Parameter <a href="#case-foot-plates-include">`include`</a>
        - Parameter <a href="#case-foot-plates-height">`height`</a>
        - Parameter <a href="#case-foot-plates-polygons">`polygons`</a>
- Section <a href="#mcu">`mcu`</a>
    - Parameter <a href="#mcu-include">`include`</a>
    - Parameter <a href="#mcu-preview">`preview`</a>
    - Parameter <a href="#mcu-type">`type`</a>
    - Parameter <a href="#mcu-margin">`margin`</a>
    - Section <a href="#mcu-position">`position`</a>
        - Parameter <a href="#mcu-position-prefer-rear-housing">`prefer-rear-housing`</a>
        - Parameter <a href="#mcu-position-anchor">`anchor`</a>
        - Parameter <a href="#mcu-position-corner">`corner`</a>
        - Parameter <a href="#mcu-position-offset">`offset`</a>
        - Parameter <a href="#mcu-position-rotation">`rotation`</a>
    - Section <a href="#mcu-support">`support`</a>
        - Parameter <a href="#mcu-support-style">`style`</a>
        - Parameter <a href="#mcu-support-preview">`preview`</a>
        - Parameter <a href="#mcu-support-height-factor">`height-factor`</a>
        - Parameter <a href="#mcu-support-lateral-spacing">`lateral-spacing`</a>
        - Section <a href="#mcu-support-lock">`lock`</a>
            - Section <a href="#mcu-support-lock-fastener">`fastener`</a>
                - Parameter <a href="#mcu-support-lock-fastener-style">`style`</a>
                - Parameter <a href="#mcu-support-lock-fastener-diameter">`diameter`</a>
            - Section <a href="#mcu-support-lock-socket">`socket`</a>
                - Parameter <a href="#mcu-support-lock-socket-thickness">`thickness`</a>
            - Section <a href="#mcu-support-lock-bolt">`bolt`</a>
                - Parameter <a href="#mcu-support-lock-bolt-clearance">`clearance`</a>
                - Parameter <a href="#mcu-support-lock-bolt-overshoot">`overshoot`</a>
                - Parameter <a href="#mcu-support-lock-bolt-mount-length">`mount-length`</a>
                - Parameter <a href="#mcu-support-lock-bolt-mount-thickness">`mount-thickness`</a>
        - Section <a href="#mcu-support-stop">`stop`</a>
            - Parameter <a href="#mcu-support-stop-anchor">`anchor`</a>
            - Parameter <a href="#mcu-support-stop-direction">`direction`</a>
            - Section <a href="#mcu-support-stop-gripper">`gripper`</a>
                - Parameter <a href="#mcu-support-stop-gripper-notch-depth">`notch-depth`</a>
                - Parameter <a href="#mcu-support-stop-gripper-total-depth">`total-depth`</a>
                - Parameter <a href="#mcu-support-stop-gripper-grip-width">`grip-width`</a>
- Section <a href="#connection">`connection`</a>
    - Parameter <a href="#connection-include">`include`</a>
    - Parameter <a href="#connection-socket-size">`socket-size`</a>
    - Parameter <a href="#connection-socket-thickness">`socket-thickness`</a>
    - Section <a href="#connection-position">`position`</a>
        - Parameter <a href="#connection-position-prefer-rear-housing">`prefer-rear-housing`</a>
        - Parameter <a href="#connection-position-anchor">`anchor`</a>
        - Parameter <a href="#connection-position-corner">`corner`</a>
        - Parameter <a href="#connection-position-raise">`raise`</a>
        - Parameter <a href="#connection-position-offset">`offset`</a>
        - Parameter <a href="#connection-position-rotation">`rotation`</a>
- Section <a href="#wrist-rest">`wrist-rest`</a>
    - Parameter <a href="#wrist-rest-include">`include`</a>
    - Parameter <a href="#wrist-rest-style">`style`</a>
    - Parameter <a href="#wrist-rest-preview">`preview`</a>
    - Section <a href="#wrist-rest-position">`position`</a>
        - Parameter <a href="#wrist-rest-position-anchor">`anchor`</a>
        - Parameter <a href="#wrist-rest-position-corner">`corner`</a>
        - Parameter <a href="#wrist-rest-position-offset">`offset`</a>
    - Parameter <a href="#wrist-rest-plinth-height">`plinth-height`</a>
    - Section <a href="#wrist-rest-shape">`shape`</a>
        - Section <a href="#wrist-rest-shape-spline">`spline`</a>
            - Parameter <a href="#wrist-rest-shape-spline-main-points">`main-points`</a>
            - Parameter <a href="#wrist-rest-shape-spline-resolution">`resolution`</a>
        - Section <a href="#wrist-rest-shape-lip">`lip`</a>
            - Parameter <a href="#wrist-rest-shape-lip-height">`height`</a>
            - Parameter <a href="#wrist-rest-shape-lip-width">`width`</a>
            - Parameter <a href="#wrist-rest-shape-lip-inset">`inset`</a>
        - Section <a href="#wrist-rest-shape-pad">`pad`</a>
            - Section <a href="#wrist-rest-shape-pad-surface">`surface`</a>
                - Section <a href="#wrist-rest-shape-pad-surface-edge">`edge`</a>
                    - Parameter <a href="#wrist-rest-shape-pad-surface-edge-inset">`inset`</a>
                    - Parameter <a href="#wrist-rest-shape-pad-surface-edge-resolution">`resolution`</a>
                - Section <a href="#wrist-rest-shape-pad-surface-heightmap">`heightmap`</a>
                    - Parameter <a href="#wrist-rest-shape-pad-surface-heightmap-include">`include`</a>
                    - Parameter <a href="#wrist-rest-shape-pad-surface-heightmap-filepath">`filepath`</a>
            - Section <a href="#wrist-rest-shape-pad-height">`height`</a>
                - Parameter <a href="#wrist-rest-shape-pad-height-surface-range">`surface-range`</a>
                - Parameter <a href="#wrist-rest-shape-pad-height-lip-to-surface">`lip-to-surface`</a>
                - Parameter <a href="#wrist-rest-shape-pad-height-below-lip">`below-lip`</a>
    - Section <a href="#wrist-rest-rotation">`rotation`</a>
        - Parameter <a href="#wrist-rest-rotation-pitch">`pitch`</a>
        - Parameter <a href="#wrist-rest-rotation-roll">`roll`</a>
    - Special section `<a href="#wrist-rest-mounts">`mounts`</a>`
    - Section <a href="#wrist-rest-sprues">`sprues`</a>
        - Parameter <a href="#wrist-rest-sprues-include">`include`</a>
        - Parameter <a href="#wrist-rest-sprues-inset">`inset`</a>
        - Parameter <a href="#wrist-rest-sprues-diameter">`diameter`</a>
        - Parameter <a href="#wrist-rest-sprues-positions">`positions`</a>
    - Section <a href="#wrist-rest-bottom-plate">`bottom-plate`</a>
        - Parameter <a href="#wrist-rest-bottom-plate-include">`include`</a>
        - Parameter <a href="#wrist-rest-bottom-plate-inset">`inset`</a>
        - Parameter <a href="#wrist-rest-bottom-plate-fastener-positions">`fastener-positions`</a>
    - Parameter <a href="#wrist-rest-mould-thickness">`mould-thickness`</a>
- Section <a href="#resolution">`resolution`</a>
    - Parameter <a href="#resolution-include">`include`</a>
    - Parameter <a href="#resolution-minimum-face-size">`minimum-face-size`</a>
- Section <a href="#dfm">`dfm`</a>
    - Parameter <a href="#dfm-error-general">`error-general`</a>
    - Section <a href="#dfm-keycaps">`keycaps`</a>
        - Parameter <a href="#dfm-keycaps-error-stem-positive">`error-stem-positive`</a>
        - Parameter <a href="#dfm-keycaps-error-stem-negative">`error-stem-negative`</a>
    - Section <a href="#dfm-bottom-plate">`bottom-plate`</a>
        - Parameter <a href="#dfm-bottom-plate-fastener-plate-offset">`fastener-plate-offset`</a>
- Section <a href="#mask">`mask`</a>
    - Parameter <a href="#mask-size">`size`</a>
    - Parameter <a href="#mask-center">`center`</a>
